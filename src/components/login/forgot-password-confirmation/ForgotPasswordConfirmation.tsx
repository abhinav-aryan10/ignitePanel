...
const ForgetPasswordConfirmation: React.FC<IProps> = ({ productDetails }: IProps) => {
  ...
  return (
    <div className='forgot_password_confirm_container'>
      <div className='forgot_password_confirm_container_layout fade_in_animation_for_container'>
        <div className='forgot_password_confirm_heading'>{UiLables.LABELS.CHECK_YOUR_EMAIL}</div>
        <div className='forgot_password_confirm_info1'>
          {UiLables.LABELS.FORGOT_PASSWORD_INFO1}
          {` `}
          <span className='forgot_password_confirm_info1_email'>{productDetails.adminSentEmail}</span>
        </div>
        <div className='forgot_password_confirm_info2'>{UiLables.LABELS.FORGOT_PASSWORD_INFO2}</div>
        <div className='forgot_password_confirm_loginbtn'>
          <button
            ...
            className={`${returnLoginPressed ? 'light_blue_btn_pressed' : 'light_blue_btn'}`}
            type='button'
            onClick={() => {
              buttonClickSound();
        ...
        <div className='forgot_password_confirm_infofooter'>
          <span className='forgot_password_confirm_infofooter_que'>{UiLables.LABELS.FORGOT_PASSWORD_INFOFOOTER1}</span>
          {` `}
