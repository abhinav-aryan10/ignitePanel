...
//   const focusSendLinkButton = (keyEvent: {
//     key: string;
//     preventDefault: () => void;
//   }) => {
...
//           {UiLables.LABELS.RESET_YOUR_PASSWORD}
//         </div>
//         <div className="forgot_password_info">
//           {UiLables.LABELS.RESET_PASSOWPRD_INFO}
//         </div>
//         <div className="forgot_password_inputs">
//           <div className="forgot_password_input_email">
//             <label className="forgot_password_input_label">
...
//                   ? "forgot_password_input_box_error"
//                   : ""
...
//             }}
//             className={`${
//               sendLinkPressed ? "light_blue_btn_pressed" : "light_blue_btn"
//             } ${emailAddress === "" ? "btn_disabled" : ""} ${
