...
import { emailMaxLength } from '../../../constants/Login.constants';
      ...
      <div className='login_card_container_layout fade_in_animation_for_container'>
        <div className='login_card_container_inputs'>
          <div className='login_card_container_input_email'>
            <label className='login_card_container_input_label'>{UiLables.LABELS.EMAIL_ADDRESS}</label>
            <input
              autoFocus
              id='emailInput'
              tabIndex={0}
              className={`${validateInputs.email.display ? 'login_card_container_input_box_error' : ''} login_card_container_input_box`}
              type='text'
          ...
          <div className='login_card_container_input_password'>
            <label className='login_card_container_input_label'>{UiLables.LABELS.PASSWORD}</label>
            {isShowPasswordEnabled ? (
              <input
                id='passwordInput'
                className={`${
                  validateInputs.password.display ? 'login_card_container_input_box_error' : ''
            ...
            {validateInputs.password.display && validateInputs.password.message !== '' ? (
              <span className='login_card_container_input_error'>
                <ErrorMessagePopup errorMessage={validateInputs.password.message} />
              </span>
            ) : (
              <></>
            )}
        ...
        <div className='login_card_container_forgetps_bt'>
          <button
            ...
            className={`${forgetPasswordPressed ? 'thick_purple_btn_pressed' : 'thick_purple_btn'}`}
            type='button'
            onClick={() => {
              buttonClickSound();
        ...
        {!showCircularLoader ? (
          <div className='login_card_container_login_bt'>
            <button
              ...
              className={`${loginPressed ? 'light_blue_btn_pressed' : 'light_blue_btn'} ${
          ...
          <div className='login_card_container_login_bt'>
            <CircularLoader loaderSize='small' />
          </div>
        )}
      </div>
    </div>
