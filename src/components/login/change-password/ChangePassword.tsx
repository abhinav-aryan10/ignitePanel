  ...
  return (
    <div className='change_password_container'>
      <div className='change_password_container_layout fade_in_animation_for_container'>
        <div className='change_password_container_heading'>{UiLables.LABELS.SET_A_NEW_PASSWORD}</div>
        <div className='change_password_container_inputs'>
          <div className='change_password_container_input_email'>
            <label className='change_password_container_input_label'>{UiLables.LABELS.NEW_PASSWORD}</label>
            {isShowPasswordNewEnabled ? (
              <input
                autoFocus
                id='passwordNewInput'
                className={`${
                  validateInputs.passwordNew.display ? 'change_password_container_input_box_error' : ''
            ...
            >
              {isShowPasswordNewEnabled ? (
                <img draggable='false' src={showPasswordIcon} alt='Show Password' />
              ) : (
                <img draggable='false' src={dontShowPasswordIcon} alt="Don't Show Password" />
              )}
            </button>
            {validateInputs.passwordNew.display && validateInputs.passwordNew.message !== '' ? (
              <span className='change_password_container_input_error'>
                <ErrorMessagePopup errorMessage={validateInputs.passwordNew.message} />
              </span>
            ) : (
              <></>
            )}
          ...
          <div className='change_password_container_input_password'>
            <label className='change_password_container_input_label'>{UiLables.LABELS.CONFIRM_PASSWORD}</label>
            {isShowPasswordConfirmEnabled ? (
              <input
                id='passwordConfirmInput'
                className={`${
                  validateInputs.passwordConfirm.display ? 'change_password_container_input_box_error' : ''
                } change_password_container_input_box`}
                type='password'
                maxLength={passwordMaxLength}
            ...
            {validateInputs.passwordConfirm.display && validateInputs.passwordConfirm.message !== '' ? (
              <span className='change_password_container_input_error'>
                <ErrorMessagePopup errorMessage={validateInputs.passwordConfirm.message} />
              </span>
            ) : (
              <></>
            )}
        ...
        <div className='change_password_container_login_bt'>
          <button
            ...
            className={`${changePasswordPressed ? 'light_blue_btn_pressed' : 'light_blue_btn'} ${
